...
class Effects:
    ...
    def to_sexpr(self, indent=0, newline=True) -> str:
        ...
        expression = (
            f"{indents}(effects {self.font.to_sexpr()}{justify}{href}{hide}){endline}"
        )
        return expression
...
class Property:
    ...
    """The ``do_not_autoplace`` token defines if the property should be ignored during
    auto-placement."""
